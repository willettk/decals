...
# to save a sub-file with only classification info from the workflow specified, give the filename here
...
keep_nonlive = False
# by default the program only keeps columns required for stats
# use this with a specified outfile_csv to save all columns, including annotations.
# (If you're not using outfile_csv this will just waste memory.)")e
keep_allcols = False
