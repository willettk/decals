...
def nsa_decals_dr3():
    return Table([
        ...
        {'iauname': 'gal_a',
         ...
         'petroth50': 3.46419,
         'petroth90': 10.4538,
         'fits_loc': '{}/example_a.fits'.format(TEST_DIR)},
        ...
        {'iauname': 'gal_b',
         ...
         'petroth50': 2.28976,
         'petroth90': 5.20297,
         'fits_loc': '{}/example_b.fits'.format(TEST_DIR)},
        ...
        {'iauname': 'gal_c',
         ...
         'petroth50': 7.16148,
         'petroth90': 24.7535,
         'fits_loc': '{}/example_c.fits'.format(TEST_DIR)},
        ...
        {'iauname': 'gal_missing_in_dr2',
         ...
         'petroth50': 7.16148,
         'petroth90': 24.7535,
         'fits_loc': '{}/example_c.fits'.format(TEST_DIR)}  # good path, unlike in dr2
    ])
...
def nsa_decals_dr2():
    ...
    return Table([
        {'iauname': 'gal_b',
         ...
         'petroth50': 2.28976,
         'petroth90': 5.20297,
         'fits_loc': '{}/example_c.fits'.format(TEST_DIR)},  # points to dif. fits file than dr3
        ...
        {'iauname': 'gal_c',
         ...
         'petroth50': 7.16148,
         'petroth90': 24.7535,
         'fits_loc': '{}/example_c.fits'.format(TEST_DIR)},  # points to same fits file as dr3
...
def test_fits_are_identical():
    fits_a_loc = '{}/example_a.fits'.format(TEST_DIR)
    fits_b_loc = '{}/example_b.fits'.format(TEST_DIR)
