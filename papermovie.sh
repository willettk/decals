...
#x=0
#for f in `ls -1 movie/*.png | grep -v "movie\-1.png" | sort -n`; do
#    n=`printf "%03d" $x`
#    #mv $f movie/$n.png
#    #convert movie/$n.png -crop 1280x568+0+0 movie/a$n.png # the formula above results in 1281x568 images
...
#rm *-1.png
#
ffmpeg -r 5 -i movie/%03d.png -vcodec libx264 -pix_fmt yuv420p -b 8000k movie/movie.mov
#
#cd ..
