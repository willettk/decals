...
%DECAM: 17.08, NSA: 17.02, diff = 0.065
%DECAM: 16.32, NSA: 16.24, diff = 0.073
%DECAM: 14.76, NSA: 14.37, diff = 0.389
%DECAM: 17.73, NSA: 17.71, diff = 0.020
%DECAM: 16.16, NSA: 16.06, diff = 0.103
...
There were a total of 32,429~images classified in DR1 of . The final data set consists of 1,290,465~classifications by 15,990~registered users. The most prolific single user classified 20,272 galaxies (63\% of the sample).

The main period of classifications for  ran from 21 Sep 2015 to 15 Feb 2016; images were retired once they had been classified 40 times apiece. After reaching this limit for the full sample, the retirement threshold was raised to 60 in order to improve statistics on disk/featured galaxies and provide a bridge to the DR2 phase.

Vote fractions for  were collated and combined using equal weighting for each users. A more advanced weighting scheme based on group agreement is intended before the final data release.
...
\begin{figure}
\centering
\includegraphics[width=80mm]{../plots/collected.pdf}
